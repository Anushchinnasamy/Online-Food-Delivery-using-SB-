...
public interface MenuItemRepository extends JpaRepository<MenuItem, Long> {
    ...
    /**
     * Find menu items by restaurant ID - with ordering
     */
    ...
    /**
     * Find available menu items by restaurant ID - with ordering
     */
     ...
     */
    List<MenuItem> findByRestaurantIdAndCategoryAndIsAvailableTrueAndDeletedAtIsNull(Long restaurantId, String category);
    
    /**
     * Find menu items by restaurant ID and category - with ordering
     */
     ...
     */
    List<MenuItem> findByNameContainingIgnoreCaseAndIsAvailableTrueAndDeletedAtIsNull(String name);
    
    /**
     * Find menu items by name containing (case-insensitive) - alternative
     */
     ...
     */
    List<MenuItem> findByRestaurantIdAndIsVegetarianTrueAndIsAvailableTrueAndDeletedAtIsNull(Long restaurantId);
    
    /**
     * Find vegetarian menu items by restaurant - with ordering
     */
